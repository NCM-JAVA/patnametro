                ...
                <div class="col-md-6 rating-reveal tab-100">
                    ...
                    <div class="productRating">
                        ...
                        <form class="form" action="{{URL ::to('/feedback/process/')}}" method="post">
                            ...
                            <input type="text" name="name" class="form-control form-group" value="{{ old('name') }}" maxlength="32" />
                            @if($errors->has('name'))
                            ...
                            <input type="text" name="phone" class="form-control form-group" value="{{ old('phone') }}" maxlength="12" />
                            @if($errors->has('phone'))
                                <span class="text-danger">{{ $errors->first('phone') }}</span>
                            @endif

                            <label for="comments" class="form_lable">{{get_title('comment',$langid1)->title}}<span class="text-danger">*</span></label>
                            <textarea name="comments" class="form-control form-group" rows="4" maxlength="240">{{ old('comments') }}</textarea>
